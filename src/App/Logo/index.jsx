...
const Logo = () => {
  ...
  const handleMouseMove = useCallback(e => {
    ...
    let relativeX1 = e.pageX-windowW/2+.904*rem2px;
    let relativeX2 = e.pageX-windowW/2-.904*rem2px;
    let relativeY = e.pageY-1.46*rem2px;
  ...
  return (
    <div id="logo-container">
      <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="logo">
        <ellipse id="Ellipse 11" cx="13.0934" cy="18.8568" rx="9.27507" ry="8.35837" fill="white"/>
        <ellipse id="Ellipse 12" cx="40.1927" cy="18.8568" rx="9.27507" ry="8.35837" fill="white"/>
        ...
        <motion.path initial={{pathLength:0}} animate={{pathLength:1}} transition={{duration:.5, delay:.25}} id="Ellipse 10" d="M39.1111 48.3459C34.3278 49.1893 29.4002 48.4968 25.0346 46.3676C20.6691 44.2384 17.0897 40.7817 14.8094 36.4932" stroke="#307BFF" strokeWidth="6"/>
        </g>
      </svg>
    </div>
  )
